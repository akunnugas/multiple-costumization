...
{
    protected $level = Wilayah::LEVEL_PROVINCE;
    ...
    public function index(Request $request)
    {
        ...
        $filter = [
            'id_parent' => ['options' => $this->service->options(Wilayah::LEVEL_COUNTRY), 'label' => 'Negara'],
        ];

        $viewData['sidebar'] = Menu::masterSidebar('region');

        return WebController::index($this->service, $request, $header, $filter, $viewData, customMethod: 'indexProvinces');
    }
    ...
    private function defineFormFields()
    {
        return [
            ...
            ['field' => 'id_parent', 'options' => $this->service->options(Wilayah::LEVEL_COUNTRY), 'control' => 'select'],
        ];
    }
}
