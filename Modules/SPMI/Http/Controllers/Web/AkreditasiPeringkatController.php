...
class AkreditasiPeringkatController extends Controller
{
    /**
     * Create a new controller.
     * @return void
     */
    public function __construct(private AkreditasiPeringkatManagementService $service) {}
    ...
    public function index(Request $request, $PenilaianPanduanId)
    {
        ...
        return WebController::index($this->service, $request, $header, [], $viewData,  model: AkreditasiPeringkat::class, isReference: true);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return WebController::show(
            ...
            id: $id,
            cards: $cards,
            model: AkreditasiPeringkat::class,
            viewData: $viewData,
            data: [
                'cards' => $cards,
            ]
    ...
    public function store(Request $request, $PenilaianPanduanId)
    {
        ...
        return WebController::store($this->service, $request, $fields, AkreditasiPeringkat::class, isReference: true);
    }
    ...
    {
        return WebController::update($this->service, $PenilaianPanduanId, $request, $this->defineFormFields(), AkreditasiPeringkat::class, isReference: true);
    }
