...
class IndicatorFooterController extends Controller
{
    /**
    ...
    public function index(Request $request, int $idIndicator)
    {
        ...
        $this->service->setCellCategory(IndikatorCell::FOOTER);
    ...
    {
        $viewData['lastBreadcrumb'] = MenuHelper::getItem(Menu::class, "indicatorSidebar.{$idIndicator}.indicator-footers", includes: true);
    ...
    {
        $request->merge(['id_indikator_laporan_kinerja' => $idIndicator, 'kategori_cell' => IndikatorCell::FOOTER]);
    ...
    private function defineFormFields()
    {
        return [
            ['field' => 'column_to'],
            ['field' => 'row_to'],
            ['field' => 'jenis_cell', 'options' => IndikatorCell::FOOTER_ACTION],
            ['field' => 'posisi_label'],
            ['field' => 'nama'],
            ['field' => 'properti'],
            ['field' => 'colspan'],
            ['field' => 'rowspan'],
            ['field' => 'apakah_sub_footer', 'control' => 'switch'],
