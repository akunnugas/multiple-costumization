...
{
    protected $level = Wilayah::LEVEL_CITY;
    ...
    public function index(Request $request)
    {
        ...
        $filter = [
            'id_parent' => ['options' => $this->service->options(Wilayah::LEVEL_PROVINCE), 'label' => 'Provinsi'],
        ];

        $viewData['sidebar'] = Menu::masterSidebar('region');

        return WebController::index($this->service, $request, $header, $filter, $viewData, customMethod: 'indexCities');
    }
    ...
    private function defineFormFields()
    {
        return [
            ...
            ['field' => 'id_parent', 'options' => $this->service->options(Wilayah::LEVEL_PROVINCE), 'control' => 'select'],
        ];
    }
}
