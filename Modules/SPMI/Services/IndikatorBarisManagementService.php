...
class IndikatorBarisManagementService
{
    /**
     * @var IndikatorBaris
     */
    protected $model = IndikatorBaris::class;
     ...
     * @param int $id
     *
     * @return IndikatorBaris
     */
    public function show(int $id): IndikatorBaris
    {
     ...
     * @return IndikatorBaris
     */
    public function store(array $data): IndikatorBaris
    {
     ...
     * @return IndikatorBaris
     */
    public function update(array $data, int $id): IndikatorBaris
    {
