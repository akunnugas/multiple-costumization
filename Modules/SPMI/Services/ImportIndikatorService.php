            ...
            foreach ($matrices as $key => $row) {
                ...
                $new = IndikatorLaporanKinerja::updateOrCreate(
                    ...
                    [
                        ...
                        'apakah_parent' => false,
                        'apakah_aktif' => (is_bool($row[4]) && $row[4]) || (is_string($row[4]) || $row[4] === 'TRUE') ? true : false,
                    ]
                );
            ...
            foreach ($matrices as $key => $row) {
                ...
                $new = IndikatorEvaluasiDiri::updateOrCreate(
                    ...
                    [
                        ...
                        'deskripsi' => $row[2] ?? null,
                        'apakah_aktif' => (is_bool($row[3]) && $row[3]) || (is_string($row[3]) || $row[3] === 'TRUE') ? true : false,
                        'apakah_data_default' => false,
                        'apakah_parent' => false,
                    ]
                );
