@php
    ...
    $startDateName = 'tanggal_awal_pengisian';
    $endDateName = 'tanggal_akhir_pengisian';
...
<div class="util_w-100">
    <div class="util_d-flex util_w-100">
        <div class="util_w-45">
            ...
            @php($attributes['wire:model'] = 'record.tanggal_awal_pengisian')
        ...
        <div class="util_w-45">
            ...
            @php($attributes['wire:model'] = 'record.tanggal_akhir_pengisian')
            <x-core::controls.input {{ $attributes }} />
        </div>
    </div>
