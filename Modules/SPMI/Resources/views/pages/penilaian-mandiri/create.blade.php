@php
    ...
    // default title
    $title = 'Pengisian Penilaian Mandiri';
...
<x-core::form id="penilaian-form">
            ...
            <div class="card__header">
                ...
                <div class="button-group">
                    <div class="button-group__left">
                        <a class="btn btn_outline btn_xs" href="{{ route('spmi.penilaian-mandiri.index') }}">
                            Kembali ke List
                        </a>
                        ...
                        @if ($isCanAction)
                            @if ($isInternalRole && $isFinalized && $isValidAssessmentDate)
                            ...
                            <button type="button" class="btn btn_primary btn_xs" data-toggle="modal"
                                ...
                                {{ $isShowScoreForm || !$isValidAssessmentDate || $isNotFinalizedTargetIndikator || (!$isInternalRole && !$isRoleFinalisasi) ? 'disabled' : null }}>
                        ...
                        <div class="box-table">
                            <div class="box-table__content">
                                    ...
                                    @php
                                        ...
                                        $totalEmptyMatrixIndicator = count(
                                            array_filter(
                                                $assessmentMatrices,
                                                fn($item) => $item->kategori_penilaian ==
                                                    PenilaianMatriks::CATEGORY_INDICATOR && empty($item->nilai_auditee),
                                            ),
                                        );
                                    @endphp
                                ...
                                <div class="filter-section">
                                    ...
                                    <div class="filter-bar kategori-pengisian">
                                        <x-core::controls.select label="Kategori Penilaian" purpose="filter"
                                            ...
                                            :options="[PenilaianMatriks::TYPE_QUALITATIVE => 'Kualitatif', PenilaianMatriks::TYPE_QUANTITATIVE => 'Kuantitatif', PenilaianMatriks::TYPE_MIXED => 'Gabungan (Kuantitatif & Kualitatif)']" :value="$filterCategory"
                                            :selected="empty($filterCategory) ? 'all' : $filterCategory" />
                                    </div>
                                    <div class="filter-bar status-pengisian">
                                        <x-core::controls.select label="Status Pengisian" purpose="filter"
                                            wire:change="updateFilter($event.target.value)"
                                            :options="['checked' => 'Terisi', 'unchecked' => 'Belum Terisi']" :value="$filterElement"
                                    ...
                                    <table class="table-data">
                                        ...
                                        <tbody>
                                            @foreach ($filteredMatrices as $item)
                                                ...
                                                <tr @if (isset($item['id_parent']))  @endif
                                                    @class([
                                                    ...
                                                    @if ($isIndicator)
                                                        ...
                                                        <td>
                                                            <div class="util_d-flex util_flex-center util_w-100">
                                                                @php
                                                                    $auditorStatus =
                                                                        $item['status_penilaian_auditee'] ?? null;
                                                                ...
                                                                <p @class([
                                                                    ...
                                                                    'color-danger' => $auditorStatus == PenilaianSkor::STATUS_BELUM_MEMENUHI,
                                                                ])>
                                                                ...
                                                                @foreach ($listPenilaianMatriksSkor as $idx => $skorItem)
                                                                    @php
                                                                        ...
                                                                        $isDisable =
                                                                            ...
                                                                            false;
                                                                        $isEndDisable =
                                                                            $penilaianMatriksSkor['end_disable'] ??
                                                                            false;
                                                                        $colspan =
                                                                            $penilaianMatriksSkor['colspan'] ?? 0;
                                                                        $disableScore =
                                                            ...
                                                            <td colspan="100">
                                                                <div class="section-inline-form feedback">
                                                                    ...
                                                                    <div class="section-inline-form__reference">
                                                                        <p class="description">{!! $item['deskripsi'] !!}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                ...
                                <x-core::handler id="no-data" :withHandleButton="false" :title="empty($filteredMatrices) && (!empty($filterElement) || !empty($search))
                                    ...
                                    : 'Belum Ada Data'" :subtitle="empty($filteredMatrices) && (!empty($filterElement) || !empty($search))
                                    ? 'Data yang Anda cari tidak ditemukan, silahkan coba kata kunci lain dan filter yang lain'
                                    : 'Data indikator penilaian belum tersedia'"
                                    @style([
    ...
    <x-core::modal title="{{ $isFinalized ? 'Batalkan Finalisasi Data' : 'Finalisasi Data' }}" variant="primary"
        ...
        <x-core::modal.body>
            ...
            @else
                Apakah Anda yakin ingin finalisasi data penilaian mandiri?
