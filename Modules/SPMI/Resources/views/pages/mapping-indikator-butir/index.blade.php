            ...
            <x-core::table>
                ...
                <div class="alert alert alert_helper">
                    <div class="alert__content">
                        <p>
                            Data ini menampilkan hasil <b>mapping antara indikator Laporan Kinerja (LK)</b> dan komponen
                            Evaluasi Diri (ED) untuk setiap unit kerja. Pastikan semua program studi memiliki status
                            <b>Sudah Mapping</b> sebelum proses audit dilaksanakan.
                        </p>
                    </div>
