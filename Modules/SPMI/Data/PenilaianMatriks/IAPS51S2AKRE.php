...
class IAPS51S2AKRE extends MigrateFormula
{
    protected string $assessmentGuideCode = 'IAPS5.1-S2-Akre';
        ...
        return [
            ...
            'B106C' => [
                ...
                "TS-0 = YEAR(-1);
                    ...
                    __SHOW__ = [GB], [LK], [PDJA], [TBERDIRI_FORMAT _AS_ 'Usia Prodi'];
                ",
                'rumus_skor' => [
                    '1' => [
                        'rumus_penilaian' => "X = CASES([PDJA] >= 2, 1, [TBERDIRI] < 2, 1);",
                        'kriteria' => "X"
                    ],
                    '0' => [
                        'rumus_penilaian' => "X = 0;",
            ...
            'B112A' => [
                ...
                "NL = SUM('1.1.c.7', null, {X2}{Y1}:{X4}{Y1});
                    ...
                    TBERDIRI = DATE_DIFF([UNIT_DATE], [TS-0], 'Y');
                    TBERDIRI_FORMAT = CONCAT([TBERDIRI], ' Tahun');
                    __SHOW__ = [A], [B], [C], [D], [NA1], [NA2], [NA3], [NA4], [RPKID_PEMBANDING _AS_ 'Jumlah Keseluruhan Publikasi'], [RPKID_FORMAT _AS_ 'RPKID'], [NL], [PK1MTK_FORMAT _AS_ PK1MTK], [PK2MTK_FORMAT _AS_ PK2MTK], [TBERDIRI_FORMAT _AS_ 'Usia Prodi'];",
                'rumus_skor' => [
                    '1' => [
                        'rumus_penilaian' => "X = CASES([NL] <= 5 & [PK1MTK] >= 0 & [PK2MTK] >= 60 & [RPKID] >= 10, 1, [TBERDIRI] < 2, 1);",
                        'kriteria' => "X"
                    ],
                    '0' => [
                        'rumus_penilaian' => "X = 0;",
            ...
            'B217C' => [
                ...
                'rumus_skor' => [
                    '1' => [
                        'rumus_penilaian' => "X = CASES([PPDM] >= 10, 1);",
                        'kriteria' => 'X'
                    ],
                    '0' => [
                        'rumus_penilaian' => 'X = 0;',
            ...
            'B115' => [
                ...
                "NMA = SUM('1.1.d.12', null, {X2}{Y1}:{X4});
                    ...
                    TBERDIRI = DATE_DIFF([UNIT_DATE], [TS-0], 'Y');
                    TBERDIRI_FORMAT = CONCAT([TBERDIRI], ' Tahun');
                    __SHOW__ = [NA1], [NA2], [NA3], [NA4], [NB2], [NB3], [NC2], [NC3], [NMA], [NDPRS], [PDIP_FORMAT _AS_ 'PPID'], [RPKID_FORMAT _AS_ 'RPKID'], [NKARYA _AS_ 'Judul artikel yang disitasi'], [TBERDIRI_FORMAT _AS_ 'Usia Prodi'];",
                'rumus_skor' => [
                    '1' => [
                        'rumus_penilaian' => "X = CASES([NMA] <= 6 & [PPID] >= 10 & [RPKID] >= 10, 1, [TBERDIRI] < 2, 1);",
                        'kriteria' => 'X'
                    ],
                    '0' => [
                        'rumus_penilaian' => 'X = 0;',
            ...
            'B219B' => [
                ...
                'rumus_skor' => [
                    '1' => [
                        'rumus_penilaian' => "X = CASES([RS] >= 10, 1);",
                        'kriteria' => 'X'
                    ],
                    '0' => [
                        'rumus_penilaian' => 'X = 0;',
