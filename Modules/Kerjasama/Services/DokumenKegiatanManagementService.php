...
use Modules\Kerjasama\Models\DokumenKegiatan;
use Modules\Kerjasama\Models\Kerjasama;

// use Modules\Kerjasama\Models\PengisianPanduan;

class DokumenKegiatanManagementService
{
    /**
     * @var Kerjasama
     */
    protected $model = DokumenKegiatan::class;
    ...
    {
        $this->model = new DokumenKegiatan();
     ...
     * @return Kerjasama
     */
    public function store(array $data): DokumenKegiatan|Error
    {
        DB::beginTransaction();
    ...
    public function destroySome($ids)
    {
        try {
            DB::transaction(function () use ($ids) {
                ...
                // hapus dokumen pada dokumen_kegiatan
