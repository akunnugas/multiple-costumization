...
class OpsiPertanyaanManagementService
{
    /**
     * @var Kegiatan
     */
     ...
     * @return OpsiJawaban
     */
    public function show(int $id): OpsiJawaban
    {
     ...
     * @param array $data
     *
     * @return OpsiJawaban|Error
     */
    public function store(array $data): OpsiJawaban|Error
    {
        DB::beginTransaction();
        try {
     ...
     * @return OpsiJawaban|Error
     */
    public function update(array $data, int $id): OpsiJawaban|Error
    {
        DB::beginTransaction();
