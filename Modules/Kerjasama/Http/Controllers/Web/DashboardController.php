        ...
        $viewData = [
            ...
            'widgetCount' => [
                [
                    ...
                    'sublabel' => "Kerjasama masih dilakukan.",
                    'icon' => 'check-square-broken',
                    'color' => 'success',
                    'value' => $countData[StatusKerjasama::AKTIF] ?? 0
                ],
                [
                    'label' => StatusKerjasama::PERPANJANGANDASHBOARD,
                    'sublabel' => "Kerjasama dilanjutkan di periode selanjutnya.",
                    'icon' => 'clock-refresh',
                    'color' => 'primary',
                ...
                [
                    ...
                    'sublabel' => "Kerjasama tidak dilanjutkan",
                    'icon' => 'x-circle',
                    'color' => 'danger',
