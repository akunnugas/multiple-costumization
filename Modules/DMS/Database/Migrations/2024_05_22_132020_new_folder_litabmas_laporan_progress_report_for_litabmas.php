...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Folder::firstOrCreate([
            ...
            'nama_folder' => 'Pengajuan Pendanaan - Laporan Progress',
            'kode_folder' => FolderStructure::LITABMAS_PENGAJUAN_PENDANAAN_LAPORAN_PROGRESS,
            'apakah_hanya_lihat' => true
        ]);
    }
    ...
    public function down()
    {
        ...
        Folder::where('id_parent', $litabmas->id)
            ->where('kode_folder', FolderStructure::LITABMAS_PENGAJUAN_PENDANAAN_LAPORAN_PROGRESS)
            ->delete();
    }
};
