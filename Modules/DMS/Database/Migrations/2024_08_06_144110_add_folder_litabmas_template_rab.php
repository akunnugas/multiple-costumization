...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        Folder::firstOrCreate([
            ...
            'nama_folder' => 'Template RAB Klaster Pendanaan',
            'kode_folder' => FolderStructure::LITABMAS_KLASTER_PENDANAAN_TEMPLATE_RAB,
            'apakah_hanya_lihat' => true
        ]);
    }
    ...
    public function down()
    {
        ...
        Folder::where('id_parent', $litabmas->id)
            ->where('kode_folder', FolderStructure::LITABMAS_KLASTER_PENDANAAN_TEMPLATE_RAB)
            ->delete();
    }
};
