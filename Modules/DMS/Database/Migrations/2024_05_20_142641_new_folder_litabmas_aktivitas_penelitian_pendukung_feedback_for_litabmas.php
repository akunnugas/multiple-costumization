...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Folder::firstOrCreate([
            ...
            'nama_folder' => 'Aktivitas Peneliti - Feedback Pembimbing',
            'kode_folder' => FolderStructure::LITABMAS_AKTIVITAS_PENELITIAN_PENDUKUNG_FEEDBACK,
            'apakah_hanya_lihat' => true
        ]);
    }
    ...
    public function down()
    {
        ...
        Folder::where('id_parent', $litabmas->id)
            ->where('kode_folder', FolderStructure::LITABMAS_AKTIVITAS_PENELITIAN_PENDUKUNG_FEEDBACK)
            ->delete();
    }
};
