...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Folder::firstOrCreate([
            ...
            'nama_folder' => 'Penilaian Administrasi - Reviewer SK',
            'kode_folder' => FolderStructure::LITABMAS_AKTIVITAS_PENELITIAN_PENDUKUNG,
            'apakah_hanya_lihat' => true
        ]);
    }
 ...
 * Reverse the migrations.
    ...
    public function down()
    {
        ...
        Folder::where('id_parent', $litabmas->id)
            ->where('kode_folder', FolderStructure::LITABMAS_AKTIVITAS_PENELITIAN_PENDUKUNG)
            ->delete();
    }
};
