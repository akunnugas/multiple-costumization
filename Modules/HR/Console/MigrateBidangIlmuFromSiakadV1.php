...
class MigrateBidangIlmuFromSiakadV1 extends Command
{
    /**
     ...
     * @var string
     */
    protected $name = 'app:migrate-bidang-ilmu-from-siakad-v1 {--tenant=}';
     ...
     * @var string
     */
    protected $description = 'Migrate Data Bidang Ilmu dari Siakad V1.';
     ...
     * @var string
     */
    private string $context = 'Bidang Ilmu';
    ...
    private function processSync()
    {
        ...
        list($err, $msg) = (new BidangIlmuService())->syncBidangIlmuFromHRSiakadV1();
        if ($err) {
