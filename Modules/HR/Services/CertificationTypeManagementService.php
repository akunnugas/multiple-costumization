...
class CertificationTypeManagementService
{
    /**
     ...
     */
    public function show(int $id): CertificationType
    {
     ...
     * @return CertificationType
     */
    public function store(array $data): CertificationType
    {
     ...
     * @return CertificationType
     */
    public function update(array $data, int $id): CertificationType
    {
