...
class PerguruanTinggiController extends Controller
{
    ...
    {
        return WebController::create($this->defineFormFields(), PerguruanTinggi::class);
    }
    ...
    {
        return WebController::store($this->service, $request, $this->defineFormFields(), PerguruanTinggi::class);
    }
