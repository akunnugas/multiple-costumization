...
class JenjangPendidikanController extends Controller
{
    ...
    public function index(Request $request)
    {
        $header = [
			...
			// ['field' => 'is_pt'],
			// ['field' => 'is_pasca'],
			// ['field' => 'emis_degree_code'],
			// ['field' => 'emis_post_degree_code'],
			// ['field' => 'lecturer_emis_code'],
			['field' => 'order_index'],
        ];
    ...
    public function show($id)
    {
        ...
        return WebController::show($this->service, $id, $cards, JenjangPendidikan::class);
    }
    ...
    private function defineFormFields()
    {
        return [
			...
			['field' => 'name'],
			['field' => 'name_en'],
			['field' => 'is_academic', 'control' => 'switch'],
			['field' => 'is_pt', 'control' => 'switch'],
			['field' => 'is_pasca', 'control' => 'switch'],
			['field' => 'emis_degree_code'],
			['field' => 'emis_post_degree_code'],
			['field' => 'lecturer_emis_code'],
			['field' => 'order_index'],
