...
class KecamatanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $filter = [
            'parent_id' => ['options' => $this->service->options(Wilayah::LEVEL_CITY), 'label' => 'Kabupaten / Kota'],
        ];
    ...
    private function defineFormFields()
    {
        return [
            ...
            ['field' => 'parent_id', 'required' => true, 'options' => $this->service->options(Wilayah::LEVEL_CITY)],
        ];
    }
}
