        ...
        <div class="main__header">
            <div class="main__location">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb__item active">Pengajuan Proposal</li>
                </ul>
                <div class="main__wrapper">
                    <h1 class="main__title">Laporan Pengajuan Proposal</h1>
                </div>
            </div>
        </div>
        @php
            $link = route('laporan-pengajuan-proposal.generate');
        @endphp
