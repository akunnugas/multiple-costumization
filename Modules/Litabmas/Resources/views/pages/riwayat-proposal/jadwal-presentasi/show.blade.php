...
<x-core::layouts.main :$menu :$title :$subtitle :$action>
    ...
    <x-litabmas::layouts.detail.card title="Jadwal Presentasi" customClassBody="util_d-flex util_flex-column util_gap-1">
        <div class="box-table__content" id="jadwal-presentasi">
            <x-core::table>
                @php
                    ...
                    $showAction = false;
                @endphp
                <x-core::table.data :header="$headerJadwal" :data="$daftarJadwal"
    ...
    @pushonce('head')
        <style>
            .box-table__content#jadwal-presentasi {
                border-top: none;
            }
            .box-table__content#jadwal-presentasi .box-table__content {
                border-top: none;
                padding: 0;
            }
        </style>
