...
<x-core::layouts.main :$menu :$title :$subtitle :$action>
    ...
    <x-litabmas::layouts.detail.card title="Daftar Pembimbing" customClassBody="util_d-flex util_flex-column util_gap-1">
        <div class="box-table__content" id="daftar-pembimbing">
            <x-core::table>
                @php
                    ...
                    $showAction = false
                @endphp
                <x-core::table.data :header="$headerPembimbing" :data="$daftarPembimbing" :paginateInfo="$data"
    ...
    @pushonce('head')
        <style>
            .box-table__content#daftar-pembimbing {
                border-top: none;
            }
            .box-table__content#daftar-pembimbing .box-table__content {
                border-top: none;
                padding: 0;
            }
        </style>
