...
@php
    ...
    if (empty($isFromBimbingan)) { // jika bukan dari halaman bimbingan
        $sudahMasaPengumpulan = !empty($infoPengumpulanOutput['sudah_masuk_masa_pengumpulan_output']);
        ...
        if (!$sudahMasaPengumpulan) {
            ...
            $staticAlert = [
                'message' => 'Anda tidak dapat mengupload laporan karena bukan dalam waktu pengumpulan output.
...
<x-core::layouts.main :$menu :$title :$subtitle>
        ...
        <div class="card__header">
            <div class="card__header-left">
                <div class="card__header-block">
                    <h2 class="header__title">Output Penelitian</h2>
        ...
        <div>
            <x-core::table>
                ...
                <x-core::table.data :$header :data="$data->items" :paginateInfo="$data" :sortable="true" :$sort
                                    :$sortDesc :$edit :$showCheck :$showAction
    ...
    @if($canUpdate && empty($isFromBimbingan))
        <x-litabmas::pages.pengajuan-pendanaan.laporan-output.modal-show-page/>
    @endif
