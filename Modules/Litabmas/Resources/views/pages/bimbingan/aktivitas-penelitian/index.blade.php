...
@php
    ...
    if (!$sudahMasukPelaksanaan) {
        $staticAlert = [
            'message' => 'Feedback aktivitas penelitian hanya dapat dilakukan pada tanggal ' . $tanggalPelaksanaan . '.',
            'type' => 'warning',
            'dismissible' => false
        ];
    }
            ...
            <div class="card__header-left">
                <div class="card__header-block">
                    ...
                    <span class="header__subtitle">
                        Silahkan berikan masukkan dari hasil aktivitas penelitian yang telah dilakukan oleh peneliti.
                    </span>
                </div>
            </div>
        </div>
