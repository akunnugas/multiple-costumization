...
class MigrateMahasiswaFromSiakadV1 extends Command
{
    /**
     * The name and signature of the console command.
     */
    protected $signature = 'app:migrate-mahasiswa-from-siakad-v1 {--tenant=} {--limit=}';

    /**
     * The console command description.
     */
    protected $description = 'Migrate Data Mahasiswa From Siakad V1.';
     ...
     * @var string
     */
    private string $context = 'Mahasiswa';
     ...
     * @return int
     */
    private function processSync($limit)
    {
        $connection = config('database.connections.pgsql');

        list($err, $msg) = (new MahasiswaManagementService())->syncMahasiswaFromSiakadv1($limit);
        if ($err) {
