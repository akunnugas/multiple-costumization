...
class PenghasilanManagementService
{
    /**
     * @var Penghasilan
     */
     ...
     * @return Penghasilan
     */
    public function show(int $id): Penghasilan
    {
     ...
     * @return Penghasilan
     */
    public function update(array $data, int $id): Penghasilan
    {
