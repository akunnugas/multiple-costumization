...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            // TODO: apakah ini yang membuat debugbar kadang muncul 2?
            /* \Barryvdh\Debugbar\Middleware\InjectDebugbar::class, */
            // Untuk sekarang enable debugbar dilakukan di app service provider
            // \Modules\Core\Http\Middleware\EnableDebug::class,
            \Modules\Core\Http\Middleware\InternalGuard::class,
            \Modules\Core\Http\Middleware\ReleaseModuleGuard::class,
            \Modules\Core\Http\Middleware\SwitchDatabase::class,
            \Modules\Core\Http\Middleware\NSMTracker::class,
        ],
